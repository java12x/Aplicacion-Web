<?php /* Smarty version 2.6.14, created on 2013-02-26 23:17:03
         compiled from _Gestion/IFormulario.php */ ?>
<html>
    <head>
                                    ...
                                    <table style="width: 50%" class="tabla_formulario">
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="anio" value="<?php echo $this->_tpl_vars['valores']['ges_anio']; ?>
" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="semestre" value="<?php echo $this->_tpl_vars['valores']['ges_semestre']; ?>
" />
                                            </td>
                                        </tr>                                                           
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <label><input type="checkbox" name="estado" value="1" <?php if ($this->_tpl_vars['valores']['ges_estado'] == '1'): ?> checked <?php endif; ?> />Gesti&oacute;n actual</label>
                                            </td>
                                        </tr>
                                        <tr class="fila0">
