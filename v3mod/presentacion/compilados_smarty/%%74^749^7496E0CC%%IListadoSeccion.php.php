<?php /* Smarty version 2.6.14, created on 2013-07-05 11:43:09
         compiled from _Curriculo/IListadoSeccion.php */ ?>
<html>
    <head>    
            ...
            <div style="background-color:#FFF; width:auto; height:auto; padding:15px;"><!--  <contenido_neto> -->
                        <div class="contenido-real">            
                            <div class="contenido-real-titulo">
                                Secciones de Curriculum
                            </div>
                            <div class="contenido-real-texto">
                                <!--START LISTADO-->
                                <table style="width: 70%" class="tabla_listado" >  
                                    <tr class="fila_f">
                                        <th style="text-align: left">                        
                                            CI
                                        </th>
                                        <td>
                                            <?php echo $this->_tpl_vars['ci']; ?>
                                    ...
                                    <tr class="fila_f">
                                        ...
                                        <td>
                                            <?php echo $this->_tpl_vars['apellidos']; ?>
 <?php echo $this->_tpl_vars['nombres']; ?>

                                        </td>
                                    </tr>
                                </table>
                                <table id="tListado" style="width: 70%" class="tabla_listado" >  
                                    <thead>
                                        <tr class="fila0">
...
?>
                                        <tr <?php if ($this->_sections['i']['index'] % 2 == 0): ?>class="fila1"<?php else: ?>class="fila2"<?php endif; ?>>     
                                            ...
                                            <td style="text-align: center">
                                                <a href="Formulario.php?id=<?php echo $this->_tpl_vars['id']; ?>
&idSec=<?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['id']; ?>
">
                                            ...
                                            <td style="text-align: left">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['scur_nombre']; ?>
                                ...
                                <table style="width: 70%" class="tabla_listado" >  
                                    <tr class="fila0">
                                        <td style="text-align: center">                        
                                            <input type="button" class="boton_obscuro" value="Volver" onClick="location='Listado.php'"/>
                                        </td>
                                    </tr>
                                </table>
                                <!--END LISTADO-->
