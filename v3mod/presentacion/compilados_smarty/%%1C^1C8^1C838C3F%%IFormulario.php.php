<?php /* Smarty version 2.6.14, created on 2013-07-05 12:51:02
         compiled from Sesion/IFormulario.php */ ?>
<html>
    <head>
                    ...
                    <div style="background-color:#FFF; width:AUTO; height:auto; padding:15px;">
                        ...
                        <div class="contenido-real">
                            ...
                            <div class="contenido-real-texto"> 
                                <form name="form1" action="Procesar.php?tipo=<?php echo $this->_tpl_vars['tipo']; ?>
" method="POST">           
                                    <table style="width: 400px" class="tabla_formulario" >  
                                        ...
                                        <tr class="fila1_f">
                                            <td colspan="2" style="text-align: left">
                                                <font color="#ff0000"><?php echo $this->_tpl_vars['msgErr']; ?>
</font>
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            ...
                                            <td>
                                                <input type="text" name="snombre" value="<?php echo $this->_tpl_vars['u']; ?>
" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
