<?php /* Smarty version 2.6.14, created on 2013-07-05 12:19:48
         compiled from _AdmDocEst/IFormulario.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', '_AdmDocEst/IFormulario.php', 119, false),)), $this); ?>
<html>
    <head>
...
" />
                                        ...
                                        <tr class="fila1_f">
                                            <th>
                                                G&eacute;nero<span class="rSpan">(*)</span>
                                            </th>
                                            <td style="text-align: left">
...
" />
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td>
                                                <label><input type="checkbox" name="estado" value="1" <?php if ($this->_tpl_vars['estado'] == '1'): ?> checked <?php endif; ?> />Habilitado</label>
                                            </td>
                                        </tr>
                                        <tr class="fila0">
                                            <th colspan="2" style="text-align: left">
...
" />
                                        ...
                                        <tr class="fila1_f">
                                            <th>
                                                Contraseña<?php if ($this->_tpl_vars['accion'] != 'UPD'): ?><span class="rSpan">(*)</span><?php endif; ?>
                                            </th>
                                            <td style="text-align: left">
                                        ...
                                        <tr class="fila1_f">
                                            <th>
                                                Confirmaci&oacute;n<span class="rSpan">(*)</span>
                                            </th>
                                            <td style="text-align: left">
...
?>
                                                    <option value="<?php echo $this->_tpl_vars['grupos'][$this->_sections['i']['index']]['id']; ?>
" <?php if ($this->_tpl_vars['grupos'][$this->_sections['i']['index']]['id'] == $this->_tpl_vars['valoresU']['usu_gru_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['grupos'][$this->_sections['i']['index']]['gru_nombre']; ?>
</option>
                                                    <?php endfor; endif; ?>
                                                </select>
                                            </td>
...
"/>
                                                <input id="bSubmit" type="submit" class="boton_obscuro" value="Guardar"/>
                                                <input type="button" class="boton_obscuro" value="Cancelar" onClick="location='Listado.php?t=<?php echo $this->_tpl_vars['tipo']; ?>
'"/>
                                            </td>
                                        </tr>
                                    </table>
