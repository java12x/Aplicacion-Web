<?php /* Smarty version 2.6.14, created on 2013-07-05 11:38:14
         compiled from _Gestion/IListado.php */ ?>
...
&accion=DEL" onClick="return confirm('¿Eliminar el registro?')">
                                            ...
                                            <?php endif; ?>
                                            <td style="text-align: center">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['ges_anio']; ?>

                                            </td>                    
                                            <td style="text-align: center">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['ges_semestre']; ?>

                                            </td> 
                                            <td style="text-align: center">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['ges_estado']): ?>
