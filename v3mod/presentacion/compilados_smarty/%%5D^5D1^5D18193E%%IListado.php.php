<?php /* Smarty version 2.6.14, created on 2013-07-05 12:19:24
         compiled from _DatosCarrera/IListado.php */ ?>
<html>
    <head>
            ...
            <div style="background-color:#FFF; width:auto; height:auto; padding:15px;"><!--  <contenido_neto> -->
                        <div class="contenido-real">            
                            <div class="contenido-real-titulo">
                                Datos de la carrera <?php echo $this->_tpl_vars['nombre']; ?>

                            </div>
                            <div class="contenido-real-texto">
                                <!--START LISTADO-->
                                <table id="tListado" style="width: 50%" class="tabla_listado" >
                                    <thead>
                                        <tr class="fila0">
...
&tipo=<?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['datc_tipo']; ?>
">
                                            ...
                                            <td style="text-align: left">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['datc_titulo']; ?>
