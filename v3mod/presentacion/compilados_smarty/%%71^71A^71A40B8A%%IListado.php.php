<?php /* Smarty version 2.6.14, created on 2013-07-05 11:13:25
         compiled from _Carrera/IListado.php */ ?>
<html>
    <head>
                    ...
                    <!--  <contenido_neto> -->
                        <div class="contenido-real">            
                            ...
                            <div class="contenido-real-texto">
                                ...
                                <!--START LISTADO-->
                                <table class="tabla_listado" id="tListado" >
                                    <thead>
                                        <tr class="fila0">
...
">
                                            ...
                                            <td style="text-align: left">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['car_nombre']; ?>

                                            </td>                    
                    <!--                        <td style="text-align: left">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['car_estado']): ?>
