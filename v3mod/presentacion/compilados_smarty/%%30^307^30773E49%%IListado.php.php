<?php /* Smarty version 2.6.14, created on 2013-07-05 11:34:57
         compiled from _Grupo/IListado.php */ ?>
...
">
                                            ...
                                            <?php if ($this->_tpl_vars['p_bajaalta']): ?>
                                            <td style="text-align: center">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['gru_estado']): ?>
...
&accion=ACT">
                                            ...
                                            <td style="text-align: left">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['gru_nombre']; ?>

                                            </td>                    
                                            <td style="text-align: left">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['gru_tipo'] == 1): ?>
                                                Administrativo
                                                <?php elseif ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['gru_tipo'] == 2): ?>
                                                Docente
                                                <?php else: ?>
                                                Estudiante
                                                <?php endif; ?>
