<?php /* Smarty version 2.6.14, created on 2013-07-05 11:43:15
         compiled from _Noticia/IListadoAdm.php */ ?>
            ...
            <div style="background-color:#FFF; width:auto; height:auto; padding:15px;"><!--  <contenido_neto> -->
                        <div class="contenido-real">            
                            <div class="contenido-real-titulo">
                                Noticias - Listado de Administrativos
                            </div>
...
?>
                                        <tr <?php if ($this->_sections['i']['index'] % 2 == 0): ?>class="fila1"<?php else: ?>class="fila2"<?php endif; ?>>
                                            <td style="text-align: center">
                                                <a href="Listado.php?id=<?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['id']; ?>
">
                                                    <image title="Ver Noticias" alt="upd" src="../imgs/table.png" />
                                                </a>
                                            </td>
                                            <td style="text-align: center">
