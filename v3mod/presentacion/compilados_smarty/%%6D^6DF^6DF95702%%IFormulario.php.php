<?php /* Smarty version 2.6.14, created on 2013-07-05 11:42:14
         compiled from _Carrera/IFormulario.php */ ?>
<html>
    <head>
                                    ...
                                    <table class="tabla_formulario"  width="350">
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="nombre" value="<?php echo $this->_tpl_vars['valores']['car_nombre']; ?>
" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="descripcion" value="<?php echo $this->_tpl_vars['valores']['car_descripcion']; ?>
" />
                                            </td>
                                        </tr>                                                           
<!--                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <label><input type="checkbox" name="estado" value="1" <?php if ($this->_tpl_vars['valores']['car_estado'] == '1'): ?> checked <?php endif; ?> />Habilitada</label>
                                            </td>
                                        </tr>-->
                                        <tr class="fila0">
