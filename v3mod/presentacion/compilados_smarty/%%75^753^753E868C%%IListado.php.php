<?php /* Smarty version 2.6.14, created on 2013-07-05 11:34:08
         compiled from _AdmDocEst/IListado.php */ ?>
<html>
    <head>
            ...
            <div style="background-color:#FFF; width:auto; height:auto; padding:15px;"><!--  <contenido_neto> -->
                        <div class="contenido-real">            
                            <div class="contenido-real-titulo">
                                Listado de <?php echo $this->_tpl_vars['titulo']; ?>

                            </div>
                            <div class="contenido-real-texto">
                                <!--START LISTADO-->
                                <?php if ($this->_tpl_vars['p_nuevo']): ?>
                                <table class="botonde_edicion" > 
                                    <tr>
                                        <td>
                                            <a href="Formulario.php?t=<?php echo $this->_tpl_vars['tipo']; ?>
"><image title="Nuevo" src="../imgs/add.png"/>Nuevo</a>
                                        </td>
                                    </tr>            
                                </table>
                                <?php endif; ?>
                                <table id="tListado" style="width: 100%" class="tabla_listado" >  
                                    <thead>
                                        <tr class="fila0">
                                            <?php if ($this->_tpl_vars['p_modificar']): ?>
                                            <th style="width: 24px"></th>
                                            <?php endif; ?>
                                            <?php if ($this->_tpl_vars['p_bajaalta']): ?>
                                            <th style="width: 24px"></th>
                                            <?php endif; ?>
...
&t=<?php echo $this->_tpl_vars['tipo']; ?>
">
                                            ...
                                            <?php if ($this->_tpl_vars['p_bajaalta']): ?>
                                            <td style="text-align: center">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['estado']): ?>
                                                <a href="Procesar.php?id=<?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['id']; ?>
&accion=DEL&tipo=<?php echo $this->_tpl_vars['tipo']; ?>
">
                                                    <image title="Habilitar/Deshabilitar" alt="del" src="../imgs/check.png" />
                                                </a>
                                                <?php else: ?>
                                                <a href="Procesar.php?id=<?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['id']; ?>
&accion=ACT&tipo=<?php echo $this->_tpl_vars['tipo']; ?>
">
 ...
 <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['per_nombres']; ?>
                                            ...
                                            <td style="text-align: left">
                                                <?php echo $this->_tpl_vars['regs'][$this->_sections['i']['index']]['usu_nombre']; ?>

                                            </td>
<!--                                            <td style="text-align: center">
                                                <?php if ($this->_tpl_vars['regs'][$this->_sections['i']['index']]['estado']): ?>
                                                <image title="Habilitado" alt="OK" src="../imgs/check.png" />
                                                <?php else: ?>
                                                -
                                                <?php endif; ?>
                                            </td>-->
