                                    ...
                                    <table style="width: 80%" class="tabla_formulario">
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="nombre" value="{$valores.scur_nombre}" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            <th>
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="descripcion" value="{$valores.scur_descripcion}" />
                                            </td>
                                        </tr>                                                           
                                        <tr class="fila1_f">
                                            <th>
                                            ...
                                            <td style="text-align: left">
                                                <input type="text" name="orden" value="{$valores.scur_orden}" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            <th colspan="2">
