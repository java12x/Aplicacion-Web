                                ...
                                <form id="form1" name="form1" action="Procesar.php?id={$id}&accion={$accion}&tipo={$tipo}" method="POST">
                                    <table style="width: 70%" class="tabla_formulario" >  
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td>
                                                <input type="text" name="ci" value="{$valores.per_ci}" />
                                            </td>
                                        </tr>
                                        <tr class="fila1_f">
                                            <th>
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td>
                                                <label><input type="checkbox" name="estado" value="1" {if $estado eq "1"} checked {/if} />Habilitado</label>
                                            </td>
                                        </tr>
                                        <tr class="fila0">
                                            <th colspan="2" style="text-align: left">
                                        ...
                                        <tr class="fila1_f">
                                            <th>
                                                Contraseña{if $accion!='UPD'}<span class="rSpan">(*)</span>{/if}
                                            </th>
                                            <td style="text-align: left">
                                        ...
                                        <tr class="fila1_f">
                                            ...
                                            <td>
                                                <select name="grupoU">
                                                    ...
                                                    <option value="{$grupos[i].id}" {if $grupos[i].id==$valoresU.usu_gru_id}selected{/if}>{$grupos[i].gru_nombre}</option>
                                                    {/section}
                                                </select>
                                            </td>
                                        </tr>
                                        <tr class="fila0">
                                            <td style="text-align: center" colspan="2">
                                                ...
                                                <input type="button" class="boton_obscuro" value="Cancelar" onClick="location='Listado.php?t={$tipo}'"/>
                                            </td>
                                        </tr>
                                    </table>
                                </form>       	
